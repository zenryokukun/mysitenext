...
import noAdResultPic from "./no-ad-result.jpg";
import noAdResultPic2 from "./no-ad-result2.jpg"
...
<Caution>
<div><b>2025-10-25追記</b></div>
<div>
<a href="#no-ads">2025-10-25追記:広告除外設定の結果</a>を追記しました。
</div>
</Caution>
...
<li><a href="#no-ads">2025-10-25追記：広告除外設定の結果</a></li>
...
<h2 id="no-ads">2025-10-25追記：広告除外設定の結果</h2>

「初期表示時のビューポート内に広告が入らないように除外設定」について、一部Googleの検証が終わりましたので、結果を追記します。

<Image src={noAdResultPic} width={920} height={332} alt="fewer-needs-improvement" />

「改善が必要」はもともと58個ありましたが、27個まで減っています。この27個は現時点でまだ検証が始まってません。終われば無事ゼロになると見込んでいます。

<Image src={noAdResultPic2} width={920} height={346} alt="good score" />

差分の31個は、「良好なURL」として評価されました！

結論、私のサイトでは「アンカー広告を停止したら少し改善」し、「その状態で初期表示のビューポート内の広告を除外したらGood評価」となりました。

今のこの状態でアンカー広告を出したらどうなるか、は気になりますが、、、現時点では指標重視にしたいと思います。

しかし、収益ですが、（もともと微々たるものでしたが）1/4くらいになってしまいました。ページが表示されたらすぐ離脱される方が多かったということでしょう。

もっと中身を読んでもらえるように精進したいと思います。
...
- [【要注意】Google Search Consoleの「CLS に関する問題」とは？原因と対策を徹底解説](https://dad-union.com/cls-mobile-problem-solutions)
