...
import { checkUser, multiUploader, saveFiles, makeFolder, insertDB } from "./middleware";
...
router.post(checkUser, makeFolder, saveFiles, insertDB, async (req: NextApiRequest, res: NextApiResponse) => {
    // build(); //ビルド
